...
<div class="row">
    ...
    <div class="col-xxl-8">
        ...
        <div class="card__wrapper">
            ...
            <div class="card__title-wrap mb-20">
                ...
                <div>
                    ...
                    <p class="text-muted small mb-0">
                        Modifiez la classe, la matière, le coefficient
            ...
            {{-- Formulaire --}}
            <form
                action="{{ route('matiere_coeficients.update', $matiereCoeficient->id) }}"
                method="POST"
            >
                            ...
                            <div class="form__input">
                                ...
                                >
                                    ...
                                    @foreach($classes as $classe)
                                        ...
                                        <option
                                            value="{{ $classe->id }}"
                                            {{ old('classe_id', $matiereCoeficient->classe_id) == $classe->id ? 'selected' : '' }}
                                        >
                            ...
                            <div class="form__input">
                                ...
                                >
                                    ...
                                    @foreach($matieres as $matiere)
                                        ...
                                        <option
                                            value="{{ $matiere->id }}"
                                            {{ old('matiere_id', $matiereCoeficient->matiere_id) == $matiere->id ? 'selected' : '' }}
                                        >
                        ...
                        <div class="from__input-box">
                            ...
                            <div class="form__input">
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    placeholder="Ex : 2"
                                    value="{{ old('coefficient', $matiereCoeficient->coefficient) }}"
                                    min="0"
                                    step="0.01"
                                    required
                                >
                        ...
                        <div class="from__input-box">
                            ...
                            <div class="form__input">
                                ...
                                <input
                                    ...
                                    value="{{ old('nombre_heure', $matiereCoeficient->nombre_heure) }}"
                                    required
                                >
