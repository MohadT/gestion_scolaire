        ...
        <div class="card__wrapper">
            <div class="card__title-wrap mb-20">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card__heading-title mb-1">Modifier l'année scolaire</h5>
                        <p class="text-muted small mb-0">{{ $annee_scolaire->nom_annee_scolaire }}</p>
                    </div>
                </div>
            </div>
            ...
            <form action="{{ route('anneescolaire.update', $annee_scolaire->id) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="from__input-box">
                            ...
                            <div class="form__input">
                                <input class="form-control @error('nom_annee_scolaire') is-invalid @enderror"
                                       ...
                                       value="{{ old('nom_annee_scolaire', $annee_scolaire->nom_annee_scolaire) }}"
                                       required>
